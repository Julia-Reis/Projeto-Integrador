			...
			<div class="col-xs-12 col-md-4 col-md-offset-2 busca">
				<div class="input-group">
					<input type="text" name="busca" id="busca" class="form-control typeahead" 
							placeholder="Pesquisar pela descrição da corrida">
				...
				<div class="modal-body">
					<div class="row">
                        <div class="form-group col-sm-6 col-12">
							<label for="quilometro">Quilometro</label>
							<input type="number" name="quilometro" id="quilometro"
				...
				<div class="modal-body">
					<div class="row">
                        <div class="form-group col-sm-6 col-12">
							...
							<input type="text" name="duracao" id="duracao" placeholder="00:00:00"
								class="form-control" required />
						</div>
					</div>
				</div>
